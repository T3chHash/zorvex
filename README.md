...
[![Release](https://img.shields.io/badge/Release-v0.0.2--beta-00f2fe?style=for-the-badge&logo=github)](https://github.com/T3chHash/zorvex/releases)
...
## 💎 معرفی پلتفرم زوروکس پرو (نسخه 0.0.2 بتا - پایدار، سریع و آماده انتشار عمومی)
...
### ✨ امکانات و بهبودهای متمایز نسخه 0.0.2 (Beta):
