...
[![Release](https://img.shields.io/badge/Release-v1.0.0-00f2fe?style=for-the-badge&logo=github)](https://github.com/T3chHash/zorvex/releases)
...
## 💎 معرفی پلتفرم زوروکس پرو (نسخه پایدار 1.0.0)
...
### ✨ امکانات و قابلیت‌های متمایز نسخه 1.0.0:
1. **رفع کامل باگ‌های ورود و مدیریت پسورد (Authentication & Security):**
   - اصلاح اساسی تابع بررسی پسورد در `login.php`؛ اکنون اعتبارسنجی الگوریتم `bcrypt` و رمزهای خام با بالاترین دقت انجام می‌شود.
   - ورود دوگانه با نام کاربری یا شناسه عددی تلگرام ادمین (`id_admin`).
