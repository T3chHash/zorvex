...
## 💎 معرفی پلتفرم زوروکس پرو (نسخه پایدار 1.0.4)
...
### ✨ امکانات و بهبودهای متمایز نسخه 1.0.4:
1. **همگام‌سازی عمیق و آنی متون ربات با پنل مدیریتی (Deep Text Sync):**
   - اتصال مستقیم تمام متن‌های ذخیره‌شده در جدول `textbot` دیتابیس به پردازشگر متون و کیبورد‌های ربات تلگرام.
   - اعمال بلادرنگ تغییرات متون استارت، خرید سرویس، راهنما، قوانین، پشتیبانی، افزایش موجودی و کارت‌به‌کارت بدون نیاز به ریستارت ربات یا وب‌سرور.
   - پشتیبانی کامل از کلیدهای تو در تو (Dot Notation) و متون سفارشی.

2. **حل کامل مشکل نمایش محصولات و دسته‌بندی‌ها در ربات (Product Engine Overhaul):**
   - اصلاح کوئری‌های فیلتر محصول در ربات جهت شناسایی محصولات «همه کاربران» (`agent = 'all'`) و محصولات با چند لوکیشن.
   - رفع کامل باگ `nullProduct` ("محصولی یافت نشد") پس از افزودن محصول در پنل مدیریت.
   - اتصال بی‌نقص دسته‌بندی‌های چندمکانه و سازگاری با سیستم نمایندگان و کاربران عادی.

3. **ارتقای رابط کاربری و تجربه مدیریت در پنل (Enhanced Admin UI):**
   - شمارنده زنده تعداد محصولات هر دسته‌بندی در صفحه `category.php`.
   - نشانگر اختصاصی وضعیت نمایش در ربات (فعال / مخفی) برای محصولات و دسته‌ها.
   - طراحی اختصاصی نئونی دارک سایبرپنک هماهنگ با هویت بصری Zorvex.
