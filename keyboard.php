...
$keyboardtypepanel = json_encode([
    'inline_keyboard' => [
        ...
        [
            ...
            ['text' => $textbotlang['keyboard']['zorvexAgentPanel'], 'callback_data' => "typepanel#zorvex_agent"]
        ],
        [
...
function KeyboardProduct($location, $query, $pricediscount, $datakeyboard, $statuscustom = false, $backuser = "backuser", $valuetow = null, $customvolume = "customsellvolume", $queryParams = [])
{
    ...
    if (empty($product['inline_keyboard'])) {
        // Smart fallback: fetch available products so user never gets an empty screen
        try {
